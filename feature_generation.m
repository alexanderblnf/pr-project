function [nist_feat, nist_profile, nist_pix, nist_dis, nist_dis_cos] = feature_generation(processed_dataset, include_im_feats, include_im_profile, include_dissimilarities)
    nist_feat = [];
    nist_profile = [];
    nist_dis = [];
    nist_dis_cos = [];
    ...
    if include_dissimilarities == true
