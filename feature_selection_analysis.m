...
image_size = 20;
dataset_step = 2;
[processed_dataset_5000, data] = pre_process(dataset_step, image_size);
...
%     if i > 1
%         [errC_dis, optimal_features_dis] = feature_selection(1000, trn_dis, tst_dis, classifiers{:, i}, 20, true);
%         errC_dis_all{i - 1} = errC_dis{:, 1};
% 
%         [errC_dis_cos, optimal_features_dis_cos] = feature_selection(1000, trn_dis_cos, tst_dis_cos, classifiers{:, i}, 20, true);
